...
export class RelationVoteService {
  ...
  public getRelationVotes(spaceId: string, relationId: string) {
    return this.restHelperService.get(`/spaces/${spaceId}/relations/${relationId}/votes`).toPromise().then((res) => {
  ...
  public putRelationVote(spaceId: string, relationId: string, agentId: string,
    ...
    return this.restHelperService.put(`/spaces/${spaceId}/relations/${relationId}/votes/${agentId}`, questionVote).toPromise()
